  ...
  "node_modules/abitype/dist/esm/errors.js"() {
    ...
    BaseError = class _BaseError extends Error {
      constructor(shortMessage, args = {}) {
        ...
        const docsPath7 = args.cause instanceof _BaseError ? args.cause.docsPath || args.docsPath : args.docsPath;
        const message = [
...
var init_abi = __esm({
  "node_modules/viem/_esm/errors/abi.js"() {
    ...
    AbiErrorInputsNotFoundError = class extends BaseError2 {
      constructor(errorName, { docsPath: docsPath7 }) {
        super([
    ...
    AbiErrorSignatureNotFoundError = class extends BaseError2 {
      constructor(signature, { docsPath: docsPath7, cause }) {
        super([
...
var init_transaction = __esm({
  "node_modules/viem/_esm/errors/transaction.js"() {
    ...
    TransactionExecutionError = class extends BaseError2 {
      constructor(cause, { account: account2, docsPath: docsPath7, chain, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to, value }) {
...
var init_decodeFunctionResult = __esm({
  "node_modules/viem/_esm/utils/abi/decodeFunctionResult.js"() {
    ...
    init_decodeAbiParameters();
    init_getAbiItem();
    docsPath3 = "/docs/contract/decodeFunctionResult";
  }
});
    ...
    BaseError3 = class _BaseError extends Error {
      ...
      constructor(shortMessage, options = {}) {
        ...
        const message = [
          ...
          ...details || docsPath7 || showVersion ? [
            "",
            details ? `Details: ${details}` : void 0,
            docsPath7 ? `See: ${docs}` : void 0,
...
var multicall3Abi, batchGatewayAbi, universalResolverErrors, universalResolverResolveAbi, universalResolverReverseAbi, erc20Abi;
var init_abis = __esm({
  "node_modules/viem/_esm/constants/abis.js"() {
    multicall3Abi = [
      {
...
function encodeDeployData(parameters) {
  ...
  if (!description)
    throw new AbiConstructorNotFoundError({ docsPath: docsPath4 });
  if (!("inputs" in description))
    throw new AbiConstructorParamsNotFoundError({ docsPath: docsPath4 });
...
var init_encodeDeployData = __esm({
  "node_modules/viem/_esm/utils/abi/encodeDeployData.js"() {
    ...
    init_concat();
    init_encodeAbiParameters();
    docsPath4 = "/docs/contract/encodeDeployData";
  }
});
...
function encodeErrorResult(parameters) {
  ...
  if (errorName) {
    ...
    if (!item)
      throw new AbiErrorNotFoundError(errorName, { docsPath: docsPath5 });
    abiItem = item;
  }
  if (abiItem.type !== "error")
    throw new AbiErrorNotFoundError(void 0, { docsPath: docsPath5 });
  const definition = formatAbiItem2(abiItem);
  const signature = toFunctionSelector(definition);
  let data = "0x";
  if (args && args.length > 0) {
    if (!abiItem.inputs)
      throw new AbiErrorInputsNotFoundError(abiItem.name, { docsPath: docsPath5 });
...
var init_encodeErrorResult = __esm({
  "node_modules/viem/_esm/utils/abi/encodeErrorResult.js"() {
    ...
    init_formatAbiItem2();
    init_getAbiItem();
    docsPath5 = "/docs/contract/encodeErrorResult";
  }
});
...
function encodeFunctionResult(parameters) {
  ...
  if (functionName) {
    ...
    if (!item)
      throw new AbiFunctionNotFoundError(functionName, { docsPath: docsPath6 });
    abiItem = item;
  }
  if (abiItem.type !== "function")
    throw new AbiFunctionNotFoundError(void 0, { docsPath: docsPath6 });
  if (!abiItem.outputs)
...
var init_encodeFunctionResult = __esm({
  "node_modules/viem/_esm/utils/abi/encodeFunctionResult.js"() {
    ...
    init_encodeAbiParameters();
    init_getAbiItem();
    docsPath6 = "/docs/contract/encodeFunctionResult";
  }
});
...
async function getBlock(client2, { blockHash, blockNumber, blockTag = client2.experimental_blockTag ?? "latest", includeTransactions: includeTransactions_ } = {}) {
  ...
  const format2 = client2.chain?.formatters?.block?.format || formatBlock;
...
async function fillTransaction(client2, parameters) {
  const { account: account2 = client2.account, accessList, authorizationList, chain = client2.chain, blobVersionedHashes, blobs, data, gas, gasPrice, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, nonce: nonce_, nonceManager, to, type, value, ...rest } = parameters;
...
async function prepareTransactionRequest(client2, args) {
  ...
  const { account: account_, chain = client2.chain, nonceManager, parameters } = request;
  ...
  if (parameters.includes("nonce") && typeof nonce === "undefined" && account2 && nonceManager) {
...
async function estimateContractGas(client2, parameters) {
  const { abi, address, args, functionName, dataSuffix = typeof client2.dataSuffix === "string" ? client2.dataSuffix : client2.dataSuffix?.value, ...request } = parameters;
...
async function simulateContract(client2, parameters) {
  const { abi, address, args, functionName, dataSuffix = typeof client2.dataSuffix === "string" ? client2.dataSuffix : client2.dataSuffix?.value, ...callRequest } = parameters;
...
(function(writeContract2) {
  async function internal(client2, actionFn, name, parameters) {
    const { abi, account: account_ = client2.account, address, args, functionName, ...request } = parameters;
    if (typeof account_ === "undefined")
      throw new AccountNotFoundError({
...
async function sendCalls(client2, parameters) {
  const { account: account_ = client2.account, chain = client2.chain, experimental_fallback, experimental_fallbackDelay = 32, forceAtomic = false, id, version: version4 = "2.0.0" } = parameters;
  const account2 = account_ ? parseAccount(account_) : null;
  let capabilities = parameters.capabilities;
  if (client2.dataSuffix && !parameters.capabilities?.dataSuffix) {
    ...
    const unpoll = poll(async () => {
      ...
      try {
        const result = await withRetry(async () => {
          const result2 = await getAction(client2, getCallsStatus, "getCallsStatus")({ id });
...
async function getTransaction(client2, { blockHash, blockNumber, blockTag: blockTag_, hash: hash2, index: index2, sender, nonce }) {
  ...
  const format2 = client2.chain?.formatters?.transaction?.format || formatTransaction;
...
async function getTransactionReceipt(client2, { hash: hash2 }) {
  ...
  const format2 = client2.chain?.formatters?.transactionReceipt?.format || formatTransactionReceipt;
...
async function waitForTransactionReceipt(client2, parameters) {
  const {
    checkReplacement = client2.chain?.supportsTransactionReplacementDetection ?? true,
    confirmations = 1,
    hash: hash2,
    onReplaced,
    retryCount = 6,
...
function findDeclaredToken(client2, token) {
  ...
  const chainId = client2.chain?.id;
...
async function sendTransactionSync(client2, parameters) {
  const { account: account_ = client2.account, assertChainId = true, chain = client2.chain, accessList, authorizationList, blobs, data, dataSuffix = typeof client2.dataSuffix === "string" ? client2.dataSuffix : client2.dataSuffix?.value, gas, gasPrice, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, nonce, pollingInterval, throwOnReceiptRevert, type, value, ...rest } = parameters;
  ...
  try {
    ...
    if (account2?.type === "json-rpc" || account2 === null) {
      ...
      const isWalletNamespaceSupported = supportsWalletNamespace2.get(client2.uid);
      const method = isWalletNamespaceSupported ? "wallet_sendTransaction" : "eth_sendTransaction";
        ...
        try {
          ...
          if (error.name === "InvalidInputRpcError" || error.name === "InvalidParamsRpcError" || error.name === "MethodNotFoundRpcError" || error.name === "MethodNotSupportedRpcError") {
            return await client2.request({
              ...
              supportsWalletNamespace2.set(client2.uid, true);
              return hash3;
            }).catch((e2) => {
              const walletNamespaceError = e2;
              if (walletNamespaceError.name === "MethodNotFoundRpcError" || walletNamespaceError.name === "MethodNotSupportedRpcError") {
                supportsWalletNamespace2.set(client2.uid, false);
                throw error;
              }
              throw walletNamespaceError;
            });
...
(function(transfer2) {
  ...
  function call2(client2, parameters) {
    return defineCall(getCall2(client2, parameters));
  }
...
function getCall2(client2, parameters) {
...
async function getCapabilities(client2, parameters = {}) {
  const { account: account2 = client2.account, chainId } = parameters;
...
async function prepareAuthorization(client2, parameters) {
  ...
  if (typeof authorization.chainId === "undefined")
    authorization.chainId = client2.chain?.id ?? await getAction(client2, getChainId, "getChainId")({});
...
async function sendCallsSync(client2, parameters) {
  const { chain = client2.chain } = parameters;
  const timeout = parameters.timeout ?? Math.max((chain?.blockTime ?? 0) * 3, 5e3);
...
async function signTransaction(client2, parameters) {
  const { account: account_ = client2.account, chain = client2.chain, ...transaction } = parameters;
  if (!account_)
    throw new AccountNotFoundError({
